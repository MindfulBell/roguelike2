...
/***/ function(module, exports, __webpack_require__) {
	...
	var Layout = function (_Component) {
	  ...
	  function Layout(props) {
	    ...
	    _this.animateLvl = _this.animateLvl.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(Layout, [{
	    ...
	    key: 'animateLvl',
	    value: function animateLvl() {
	      setTimeout(this.setState({ levelUp: false }), 1000);
	    }
	  }, {
	    key: 'handleKey',
	    ...
	    value: function render() {
	      ...
	      var deadMessage = this.state.playerDead ? 'YOU DIED!!' : false;
	      var winMessage = this.state.bossDead ? 'YOU WON!!' : false;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'h4',
	              { style: this.state.levelUp ? { transform: 'scale(1, 1.5)' } : {} },
	              _react2.default.createElement(
	                'span',
	                { className: 'stat-name' },
	                'Level'
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    ...
	    resetHero: function resetHero() {
	      dispatch((0, _index.resetHero)());
	    }
	  };
	};
...
//# sourceMappingURL=0.aa9ccdf8cf64b0ec914a.hot-update.js.map